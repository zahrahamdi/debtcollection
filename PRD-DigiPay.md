...
> **به‌روزرسانی:** هم‌راستا با پیاده‌سازی نسخه دمو (بخش ۱۰)  
...
| گزارشات (`Reports`) | کامل — summary، conversion، A/B |
...
| `GET /api/reports/summary` | کارت‌های آماری |
| `GET /api/reports/action-conversion` | نرخ تبدیل اقدام‌ها |
| `GET /api/reports/ab-tests` | نتایج A/B |
...
در نسخه دمو، middleware احراز هویت (`auth.js`) کاربر mock برمی‌گرداند؛ SSO/نقش واقعی برای production باقی مانده است.
