...
const LEGACY_HISTORY_OPERATION_LABELS = {
  'ارسال پیامک هشدار — تلاش مجدد': 'ارسال ناموفق پیامک هشدار',
  'ارسال پیامک تهدید — تلاش مجدد': 'ارسال ناموفق پیامک تهدید',
  'تماس خودکار هشدار — تلاش مجدد': 'تماس خودکار ناموفق هشدار',
  'تماس خودکار تهدید — تلاش مجدد': 'تماس خودکار ناموفق تهدید',
  'ارسال ناموفق پیامک — تلاش مجدد': 'ارسال ناموفق پیامک',
  'تماس خودکار ناموفق — تلاش مجدد': 'تماس خودکار ناموفق',
}

export const normalizeHistoryOperation = (operation) =>
  LEGACY_HISTORY_OPERATION_LABELS[operation] || operation

export const normalizeLastActionLabel = (label) => {
  if (label === 'تماس تلفنی مذاکره‌کننده') return 'تماس مذاکره‌کننده'
  return LEGACY_HISTORY_OPERATION_LABELS[label] || label
}
...
export const HISTORY_OPERATIONS = [
  ...
  'تماس خودکار هشدار',
  'تماس خودکار تهدید',
  'ارسال ناموفق پیامک هشدار',
  'ارسال ناموفق پیامک تهدید',
  'تماس خودکار ناموفق هشدار',
  'تماس خودکار ناموفق تهدید',
  'اجرای پیامک',
  ...
  'پرداخت کامل بدهی',
  'پرداخت جزئی بدهی',
  'پرداخت جزئی قبل از سررسید تعهد',
