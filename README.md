...
- **پرونده‌ها:** لیست، فیلتر (۱۵ وضعیت)، جزئیات، تخصیص مذاکره‌کننده، ثبت خروجی تماس (مدت تماس شرطی)
...
جزئیات: [TECHNICAL.md — موتور استراتژی](./TECHNICAL.md#۴-موتور-استراتژی-strategy-engine) · [PRD Story 3.3](./PRD-DigiPay.md#story-33-ثبت-خروجی-تماس-مذاکرهکننده)
